...
// // we memiking how is it to fetch from the sever..it may takes some time....thats wahy weare using "settimeout" here
...
// we wanted to have create post first but due to delay..getpost request happened first...this kind of sitution can happen in real world..this is where asych programming comes in like 'CALLBACK ' funtion to handle it..it will hold 
